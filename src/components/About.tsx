      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center max-w-6xl mx-auto">
          ...
          <div className="relative animate-fade-in">
            ...
            {/* Decorative line */}
            <div className="absolute -right-4 top-0 bottom-0 w-1 bg-primary/20 hidden md:block" />
          </div>
          ...
          <div className="animate-slide-up">
            ...
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-primary mb-2 tracking-wide">
              Dra. Marcela Duch
            </h2>
