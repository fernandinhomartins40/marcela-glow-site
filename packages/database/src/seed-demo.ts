...
async function main() {
  ...
  console.log(`📝 Prontuários: ${registros} · Sessões realizadas: ${sessoes}`)
  ...
  console.log(`💊 Receitas e pedidos: ${receitas}`)
  ...
  console.log(`💬 Mensagens: ${mensagens} · notificações no portal`)
  ...
  for (const [i, l] of LEADS.entries()) {
    ...
    const dados = {
      ...
      status: l.status,
      source: l.source,
      message: `Olá! Gostaria de saber o valor de ${l.interest.toLowerCase()} e a disponibilidade de horário.`,
      tenantId: tenant.id,
