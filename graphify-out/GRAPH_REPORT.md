...
## Knowledge Gaps
- **761 isolated node(s):** `Consulta`, `DashboardData`, `router`, `staffOnly`, `optionalDate` (+756 more)
...
- **What connects `Consulta`, `DashboardData`, `router` to the rest of the system?**
