...
Cohesion: 0.07
Nodes (23): Cms(), Certificate(), Config, Provider, ProviderId, ClinicalCatalog(), ClinicalDocuments(), DocumentTemplates() (+15 more)
...
Cohesion: 0.07
Nodes (53): Avisos, AvisosBarra(), EnviarAviso(), LinhaAgenda(), TodayAgenda(), EncounterDetail(), NewAppointment(), Cobranca (+45 more)
...
Cohesion: 0.05
Nodes (41): randomToken(), buildStorageKey(), opcoesComuns, presignDownload(), presignUpload(), PUBLIC_PREFIX, publicFileUrl(), s3Bucket (+33 more)
...
Cohesion: 0.19
Nodes (16): Etapa, etapaAtual(), EtapaId, etapaPorId(), Pendencias, TRILHA, Avisos, ICONE (+8 more)
...
Cohesion: 0.16
Nodes (18): Content, ContentForm(), Lead, LeadForm(), Leads(), Procedure, ProcedureForm(), Procedures() (+10 more)
...
### Community 182 - "errorMessage"
Cohesion: 0.11
Nodes (28): Caixa(), Conferencia(), DadosCaixa, MEIOS, Sessao, SessionQuickForm(), Cobranca, Dados (+20 more)
