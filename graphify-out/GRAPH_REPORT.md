...
## Knowledge Gaps
- **796 isolated node(s):** `Campo`, `Procedimento`, `Plano`, `STATUS`, `prisma` (+791 more)
...
- **What connects `Campo`, `Procedimento`, `Plano` to the rest of the system?**
